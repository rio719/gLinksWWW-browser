...
1. Instant Search Engine Switcher
...
2. Innovative Multi-Slot Clipboard
Break free from the single-item clipboard limit. gLinksWWW features a 9-Slot Multi-Copy & Paste system.

9 Concurrent Slots: Store up to 9 different text snippets or links simultaneously.

Custom Retro Menu: Access your slots via the right-click context menu.

Powerful Hotkeys: * Ctrl + Shift + 1~9 : Copy to the specific slot.

Ctrl + Alt + 1~9 : Paste from the specific slot.
...
Isolation: Manage and clear cookies for specific websites without affecting others.
